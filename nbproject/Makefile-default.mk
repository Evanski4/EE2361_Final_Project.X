...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/Main.o: Main.c  .generated_files/flags/default/d472b4899076bb838bc8b1c2d8ea2fa5e849e1a .generated_files/flags/default/da39a3ee5e6b4b0d3255bfef95601890afd80709
	@${MKDIR} "${OBJECTDIR}" 
...
${OBJECTDIR}/iLEDwriteColor.o: iLEDwriteColor.c  .generated_files/flags/default/473bd099b737ca279b438a209fc10c5847c4350 .generated_files/flags/default/da39a3ee5e6b4b0d3255bfef95601890afd80709
	@${MKDIR} "${OBJECTDIR}" 
...
${OBJECTDIR}/LCD.o: LCD.c  .generated_files/flags/default/7a4dec52c672f6eb2e40c055e08f1d16e08e6324 .generated_files/flags/default/da39a3ee5e6b4b0d3255bfef95601890afd80709
	@${MKDIR} "${OBJECTDIR}" 
...
${OBJECTDIR}/LCD.o: LCD.c  .generated_files/flags/default/addeea03508b2689011a214dfef8cba551a9f666 .generated_files/flags/default/da39a3ee5e6b4b0d3255bfef95601890afd80709
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/LCD.o.d 
	@${RM} ${OBJECTDIR}/LCD.o 
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/iLEDasm.o: iLEDasm.s  .generated_files/flags/default/2197b3a6e3fa95efd1715400d67c9956f09d5b9a .generated_files/flags/default/da39a3ee5e6b4b0d3255bfef95601890afd80709
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/iLEDasm.o.d 
	@${RM} ${OBJECTDIR}/iLEDasm.o 
	${MP_CC} $(MP_EXTRA_AS_PRE)  iLEDasm.s  -o ${OBJECTDIR}/iLEDasm.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -D__DEBUG   -omf=elf -DXPRJ_default=$(CND_CONF)    -Wa,-MD,"${OBJECTDIR}/iLEDasm.o.d",--defsym=__MPLAB_BUILD=1,--defsym=__ICD2RAM=1,--defsym=__MPLAB_DEBUG=1,--defsym=__DEBUG=1,,-g,--no-relax$(MP_EXTRA_AS_POST)  -mdfp="${DFP_DIR}/xc16"
